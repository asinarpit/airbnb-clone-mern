    ...
    <div>
      <AccountNav />
      {
        bookings?.length > 0 && bookings.map(booking => (
          <Link to={`/account/bookings/${booking._id}`} key={booking._id} className='flex gap-4 bg-gray-200 rounded-2xl overflow-hidden mt-4'>
            <div className='w-48'>
              ...
              <img className='w-full h-full object-cover' src={`http://localhost:8000/uploads/${booking.place.photos[0]}`} alt="" />
            </div>
        ...
        <BookingDates booking={booking}/>
              <div className='flex gap-1 items-center font-semibold text-md mt-2'>
